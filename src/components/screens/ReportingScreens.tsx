    ...
    <div className="space-y-5 pb-8 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {reportItems.map((r, i) => (
          <div
            key={i}
            className="p-5 rounded-2xl bg-slate-900/90 border border-slate-700/70 shadow-xl space-y-3 flex flex-col justify-between"
          >
            <div>
            ...
            <div className="pt-3 border-t border-slate-800 flex justify-between items-center">
              <span className="text-[11px] text-slate-400">PDF & CSV Ready</span>
              <button
                onClick={handlePrint}
                className="px-3 py-1 bg-slate-800 hover:bg-slate-700 text-cyan-300 rounded-lg text-xs font-semibold transition flex items-center gap-1"
              >
