  ...
  return (
    <div className="max-w-2xl mx-auto py-12 text-center space-y-6 animate-in fade-in duration-300">
      ...
      <div>
        ...
        <p className="text-sm text-cyan-300 font-medium mt-1">Smart Libraries • Better Learning</p>
      ...
      <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-700/70 text-left space-y-3 text-xs">
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 pb-8 animate-in fade-in duration-300">
      ...
      <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-700/70 shadow-2xl space-y-4 text-xs">
        <h3 className="font-bold text-sm text-white">Step {currentStep}: {steps[currentStep - 1]}</h3>
        ...
        <div className="flex justify-between pt-4 border-t border-slate-800">
          <button
            ...
            className="px-4 py-2 bg-slate-800 text-slate-300 rounded-xl font-semibold disabled:opacity-30"
          >
            Previous
          </button>
          <button
            ...
            className="px-5 py-2 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-xl font-bold flex items-center gap-1.5"
          >
  ...
  return (
    <div className="max-w-md mx-auto py-12 space-y-6 animate-in fade-in duration-300">
      <div className="text-center space-y-2">
        <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-cyan-500 to-blue-600 flex items-center justify-center mx-auto shadow-xl">
          <BookOpen className="w-8 h-8 text-white" />
        </div>
        <h1 className="text-2xl font-extrabold text-white">Welcome Back</h1>
        <p className="text-xs text-slate-400">Sign in to your authorized local desktop session</p>
      </div>

      <form onSubmit={handleLogin} className="p-6 rounded-2xl bg-slate-900/90 border border-slate-700/70 shadow-2xl space-y-4 text-xs">
        <div>
          <label className="block text-slate-400 mb-1 font-medium">Username / Email</label>
          <input
            type="text"
            value={email}
        ...
        <div>
          <label className="block text-slate-400 mb-1 font-medium">Security PIN / Password</label>
          <input
            type="password"
            value={pin}
        ...
        <div className="flex justify-between items-center text-[11px] text-slate-400">
          <label className="flex items-center gap-1.5">
            <input type="checkbox" defaultChecked className="rounded bg-slate-950 border-slate-700 text-cyan-500" />
            Remember this PC
          </label>
          <span className="text-cyan-400 cursor-pointer hover:underline">Forgot PIN?</span>
        </div>
